let entrada = prompt("¿Su destino será en el interior o exterior?");

while (entrada != "ESC") {
    switch (entrada) {
        case "interior":
            alert("Bienvenido/a, a continuación podrá calcular su viaje dentro del país")
            break;

        case "exterior":
            alert("Bienvenido/a, a continuación podrá calcular su viaje fuera del país")
            break;

        default:
            alert("ingrese la palabra dentro, si desea realizar su viaje en el país o fuera si desea realizar su viaje en el exterior")
            break;
    }
